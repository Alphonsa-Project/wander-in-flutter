...
class ResortSearchPageResult extends StatefulWidget {
  final Map<String, dynamic> userdoc;

  const ResortSearchPageResult({Key? key, required this.userdoc})
      : super(key: key);

  @override
  State<ResortSearchPageResult> createState() => _ResortSearchPageResultState();
}

class _ResortSearchPageResultState extends State<ResortSearchPageResult> {
  //String searchitem = 'stores';
  String name = '';
  String search_type = 'resort';
      ...
      child: Scaffold(
          ...
          body: ListView(
            children: [
              Column(
                children: [
                  if (search_type == "resort")
                    FirestoreQueryBuilder<Map<String, dynamic>>(
                      query: FirebaseFirestore.instance
                          .collection("resorts")
                          // .where('status', isEqualTo: true)
                          .where("name_search_key",
