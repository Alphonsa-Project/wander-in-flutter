...
class PlaceSearchPageResult extends StatefulWidget {
  final Map<String, dynamic> userdoc;
  const PlaceSearchPageResult({Key? key, required this.userdoc})
      : super(key: key);

  @override
  State<PlaceSearchPageResult> createState() => _PlaceSearchPageResultState();
}

class _PlaceSearchPageResultState extends State<PlaceSearchPageResult> {
  //String searchitem = 'stores';
  String name = '';
  String search_type = 'place';
