...
class HotelSearchPageResult extends StatefulWidget {
  final Map<String, dynamic> userdoc;
  const HotelSearchPageResult({Key? key, required this.userdoc})
      : super(key: key);

  @override
  State<HotelSearchPageResult> createState() => _HotelSearchPageResultState();
}

class _HotelSearchPageResultState extends State<HotelSearchPageResult> {
  //String searchitem = 'stores';
  String name = '';
  String search_type = 'hotel';
