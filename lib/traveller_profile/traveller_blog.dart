...
class TravellerBlogs extends StatefulWidget {
  final String uid;
  const TravellerBlogs({super.key, required this.uid});

  @override
  State<TravellerBlogs> createState() => _TravellerBlogsState();
}

class _TravellerBlogsState extends State<TravellerBlogs> {
  String image_url = '';
  String name = '';
  @override
  void initState() {
