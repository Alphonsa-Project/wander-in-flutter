...
import 'package:wander_in/traveller_profile/traveller_blog.dart';
import 'package:wander_in/traveller_profile/traveller_post.dart';
import 'package:wander_in/user_id.dart';

class TravellerProfile extends StatefulWidget {
  final String uid;
  const TravellerProfile({super.key, required this.uid});
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => TravellerPosts(
                                          uid: widget.uid,
                                          name: name,
                                          user_img: img_url,
                                        )));
