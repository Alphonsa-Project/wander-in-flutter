...
class AddToPlans extends StatefulWidget {
  final Map<String, dynamic> feedDoc;
  const AddToPlans({super.key, required this.feedDoc});

  @override
  State<AddToPlans> createState() => _AddToPlansState();
}

class _AddToPlansState extends State<AddToPlans> {
  bool loading = false;
  ...
  addFeedToPlan(String docId) {
    ...
    var newFeedData = widget.feedDoc;
    newFeedData['added_date'] = DateTime.now();
    newFeedData['type'] = 'feed';
    newFeedData['desc'] = '';
